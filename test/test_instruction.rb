...
class TestInstruction < Minitest::Test
  ...
  def test_set_instruction_invalid_label
  ...
  def test_inc_instruction_invalid_label
    assert_raises(Urm::InvalidLabel) do
  ...
  def test_dec_instruction_invalid_label
    assert_raises(Urm::InvalidLabel) do
  ...
  def test_stop_instruction_invalid_label
    assert_raises(Urm::InvalidLabel) do
  ...
  def test_copy_instruction_invalid_label
    assert_raises(Urm::InvalidLabel) do
